...
class DummyHire extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DummyHire> createState() => _DummyHireState();
}

class _DummyHireState extends ConsumerState<DummyHire> {
  ...
  @override
  void didUpdateWidget(covariant DummyHire oldWidget) {
