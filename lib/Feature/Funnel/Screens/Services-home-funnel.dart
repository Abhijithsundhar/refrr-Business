...
import 'package:refrr_admin/Feature/Funnel/Screens/select-firm.dart';
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) => SelectFirm(lead: widget.currentFirm),));
                              },
                              child: Container(
                                height: height * 0.05,
                                width: width * 0.32,
