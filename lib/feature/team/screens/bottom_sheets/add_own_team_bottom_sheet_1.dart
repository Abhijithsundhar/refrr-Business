...
import 'package:refrr_admin/feature/team/screens/bottom_sheets/add_own_team_bottom_sheet_2.dart' hide fieldHeight;
        ...
        builder: (BuildContext context, StateSetter setState) {
          ...
          Future<void> pickAndUploadImage() async {
            try {
              ...
              final uploadedUrl = await uploadImage(image: pickedFile, context: context);
